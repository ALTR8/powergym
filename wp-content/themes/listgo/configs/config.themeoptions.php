            ...
            array(
                ...
                'fields'           => array(
	                ...
	                array(
		                ...
		                'options'   => array(
			                'footer-style1'  => esc_html__('Footer Style 1 (1 Column)', 'listgo'),
			                'footer-style2'  => esc_html__('Footer Style 2 (3 Columns)', 'listgo'),
			                'footer-style3'  => esc_html__('Footer Style 3 (5 Columns)', 'listgo')
		                )
	                ),
                	array(
                        'id'        => 'footer_bg',
